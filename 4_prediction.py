...
RESULT_FILE = "4_prediction_result.txt"
...
for num_future_days in [1, 7, 30, 60]:
    ...
    train_features = train_clean_data[[
        'num_csr_sentences', 'sentiment_score', 
    ...
    # config_1 result
    config_1_feature_columns = ['num_csr_sentences', 'sentiment_score']
    ...
    # config_3 result
    config_3_feature_columns = ['num_csr_sentences', 'sentiment_score', 
